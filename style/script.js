...
const messages = [
  "Anh yêu em P.anh 💕", "Anh thương em P.anh🤗", "I Love You P.anh🥰", "Em thật xinh đẹp",
  "Hạnh phúc nhé 💫", "❤️ Gửi yêu thương ❤️", "Luôn mỉm cười nhé 😊",
  "Love You 3000 P.anh💖", "Cảm ơn vì tất cả 🌸",
  "Em là một món quà 🎁", "Trái tim này là của em P.anh💘",
  "Em làm thế giới này đẹp hơn 💐", "Love You In Every Universe P.anh",
  "Em là duy nhất 💞", "Saranghaeyo P.anh❤️",
  "Anh nhớ em nhiều 🌈", "You Are My Everything 🫶",
  "Yêu em không cần lý do 🏡", "Em là lý do anh luôn mỉm cười 😘",
  "Anh yêu em vì em là chính em ✨", "P.anh"
];
