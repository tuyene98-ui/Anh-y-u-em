...
const messages = [
  "Anh yêu em trúc phương 💕", "Anh thương em trúc phương🤗", "I Love You trúc phương🥰", "Em thật xinh đẹp",
  "Hạnh phúc nhé 💫", "❤️ Gửi yêu thương ❤️", "Luôn mỉm cười nhé 😊",
  "Love You 3000 trúc phương💖", "Cảm ơn vì tất cả 🌸",
  "Em là một món quà 🎁", "Trái tim này là của em trúc phương💘",
  "Em làm thế giới này đẹp hơn 💐", "Love You In Every Universe trúc phương",
  "Em là duy nhất 💞", "Saranghaeyo trúc phương❤️",
  "Anh nhớ em nhiều 🌈", "You Are My Everything 🫶",
  "Yêu em không cần lý do 🏡", "Em là lý do anh luôn mỉm cười 😘",
  "Anh yêu em vì em là chính em ✨", "trúc phương"
];
